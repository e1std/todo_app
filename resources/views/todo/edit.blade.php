    ...
    <div class="space-y-4">
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div class="mt-sm-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <form class="space-y-6" method="POST" action="/todos/{{ $todo->id }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="name" id="name" value="{{ $todo->name }}" required/>
                    ...
                    <x-form-field>
                        <div class="mt-2">
                            <label class="inline-flex items-center me-5 cursor-pointer">
                                <input type="checkbox" name="shared" value="1" class="sr-only peer"{{ ($todo->shared == 1 ) ? ' checked' : '' }}>
                    ...
                    <x-form-field>
                        <div class="mt-2">
                            <label class="inline-flex items-center me-5 cursor-pointer">
                                <input type="checkbox" name="completed" value="1" class="sr-only peer"{{ ($todo->completed == 1 ) ? ' checked' : '' }}>
                                <div class="relative w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-indigo-600 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                                <span class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-900">Done</span>
                            </label>
                        </div>
                    </x-form-field>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-textarea name="description" id="description" rows="8" required>{{ $todo->description }}</x-form-textarea>
